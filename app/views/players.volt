                                                ...
                                                <div id="m_table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-12">
                                                            <div class="dataTables_info" id="m_table_1_info" role="status" aria-live="polite">You are in page {{ players.current }} of {{ players.total_pages }}</div>
                                                            <div class="dataTables_paginate paging_simple_numbers" id="m_table_1_paginate">
                                                                <ul class="pagination">
                                                                    <li class="paginate_button page-item previous" id="m_table_1_previous"><a href="/list/players?page={{players.before}}" aria-controls="m_table_1" data-dt-idx="0" tabindex="0" class="page-link"><i class="la la-angle-left"></i></a></li>
                                                                    <li class="paginate_button page-item active"><a href="/list/players?page={{players.current}}" aria-controls="m_table_1" data-dt-idx="1" tabindex="0" class="page-link">{{ players.current }}</a></li>
                                                                    <li class="paginate_button page-item next" id="m_table_1_next"><a href="/list/players?page={{players.next}}" aria-controls="m_table_1" data-dt-idx="6" tabindex="0" class="page-link"><i class="la la-angle-right"></i></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
